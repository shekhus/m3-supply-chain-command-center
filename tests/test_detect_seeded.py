...
def test_the_holiday_decoy_is_reported_but_never_as_an_incident(detected: list[Anomaly]) -> None:
    ...
    # and at least one of those was an incident the policy actually stepped in and capped
    assert any("holiday" in (a.suppressed_reason or "") for a in otif_in_window)
