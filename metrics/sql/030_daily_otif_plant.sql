-- Per plant: the grain a plant lead reads, and the one permission filtering works on.
INSERT INTO metrics.daily_otif_plant AS t
    (metric_date, plant, lines, otif_rate, on_time_rate, fill_rate_count, fill_rate_weight, ordered_weight_lb)
SELECT metric_date, plant,
       count(*),
